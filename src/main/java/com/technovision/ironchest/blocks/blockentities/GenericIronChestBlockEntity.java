...
public class GenericIronChestBlockEntity extends ChestBlockEntity implements BlockEntityClientSerializable {

    ExtraChestTypes type;
    int viewerCount = 0;

    public GenericIronChestBlockEntity(ExtraChestTypes type, BlockPos pos, BlockState state) {
