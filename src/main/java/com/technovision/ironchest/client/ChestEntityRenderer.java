...
public class ChestEntityRenderer<T extends ChestBlockEntity> extends ChestBlockEntityRenderer<T> {
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (block instanceof GenericIronChestBlock) {
            GenericIronChestBlock chest = (GenericIronChestBlock)block;
            ...
            float g = ((Float2FloatFunction)properties.apply(GenericIronChestBlock.getAnimationProgressRetriever((ChestAnimationProgress)entity))).get(tickDelta);
            g = 1.0F - g;
            g = 1.0F - g * g * g;
